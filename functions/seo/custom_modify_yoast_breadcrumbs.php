...
/**
 * Customizes Yoast SEO Breadcrumbs for WooCommerce Product Pages
 *
 * This function modifies the breadcrumb trail generated by the Yoast SEO plugin
 * on single product pages within a WooCommerce-enabled WordPress site. It performs
 * the following actions:
 *   - Removes the 'מוצרים' or 'חנות' ('Products' in Hebrew) breadcrumb.
 *   - Dynamically adds the product's categories and subcategories to the breadcrumb trail.
 *   - Ensures the product name remains the last item in the breadcrumbs.
 *   - Optionally makes the product name a clickable link to its own page.
 *
 * @author      Edward Ziadeh
 * @date        September 17, 2024
 * @version     1.0
 * @link        https://shopper.shop
 */
